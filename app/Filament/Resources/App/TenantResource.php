...
use App\Filament\Resources\App\TenantResource\Pages;
use App\Filament\Resources\App\TenantResource\RelationManagers;
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                Tables\Columns\TextColumn::make('deletedBy.name')->numeric()->sortable()->toggleable(isToggledHiddenByDefault: true),
                ...
                Tables\Actions\Action::make('generatePdf')
                    ...
                    ->action(function (Tenant $record) {
                        try {
                            ...
                            $tenant  = $record->load(['tenancyAgreements.tenancyBills']);
